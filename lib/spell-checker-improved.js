...
export default {
    ...
    activate(state) {
        ...
        console.log('statusBarNotification', this.statusBarNotification);
        //this.statusBarNotification.updateCount(1);
    },
    ...
    enableObservers() {
        ...
        atom.workspace.observeTextEditors((editor) => {
            ...
            let updateMisspelled = (wordsToMark)=>{
                ...
                self.lastMisspelledWords = wordsToMark;
            ...
            editor.element.onDidChangeScrollTop(
                ()=>{
                    ...
                    self.scrollEventChecker = setTimeout(()=>{
                        ...
                        spellCheckerView.setMarkers(self.lastMisspelledWords);
                    }, 300);
                }
            );
    ...
    spellCheckOnPlugins(misspelledWords) {
        console.log('spellCheckOnPlugins', this.getPluginsOnScope());
        return misspelledWords.filter((word)=>{
            return !this.getPluginsOnScope().some(
                (plugin)=>{
        ...
        return new Promise((resolve)=>{
            ...
            this.checkMisspelling(bufferText).then(
                (e)=>{
                    ...
                    if (this.lastMisspelledWords.length > 0) {

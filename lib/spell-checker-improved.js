...
export default {
    ...
    activate(state) {
        console.log("getPathsActivate", atom.project.getPaths());
        this.statusBarNotification = new StatusBarNotification(this._getPackagePath());

        this._getKnownWordsInPaths(atom.project.getPaths());
    ...
    _setEnvironmentEvents() {
        ...
        atom.project.onDidAddRepository((e)=>console.log("repository", e));
        ...
        this.disposables.add(
            atom.commands.add('atom-workspace', {
                'spell-checker-improved-add-word:addWord': (element) => {
                    ...
                    self.addWord(element, actualFileProjectPath[0]);
                },
            })
        );
    },
